...
**Governed Multi-Agent Infrastructure for Regulated Enterprises**

> *Governed by Design.*

---

Castellan is governed multi-agent infrastructure. You define agents in YAML. Castellan builds, governs, and deploys them — with constitutional governance, OWASP Agentic security coverage, human-in-the-loop gates, compliance manifests, and a client-ready deliverable. All wired into your existing CI/CD, compliance workflows, and approval chains.
...
| **Render** | Produces governed agent package with compliance manifest and AI-SBOM |
...
**Constitutional Principles** — Every agent carries a constitution: severity-ranked values, boundaries, and commitments. Critical violations block output. High violations fail gates. The constitution is cryptographically fingerprinted at build time.

**Regulatory Mapping** — EU AI Act risk tier classification, NIST AI RMF function mapping (Govern / Map / Measure / Manage), and regulation-specific controls for HIPAA, PCI DSS, SEC, SOX, and others — all declared in the spec, enforced at build time, documented in the manifest.
...
Every agent receives a governance score (0-100) across nine factors. Agents below 70 are blocked from production deployment. Both included POC agents ship at 100.
...
Castellan is a governance infrastructure stack, not a framework. The distinction matters.
...
+-----------------------------------------------------+
|              Premium Handoff Renderer               |
+-----------------------------------------------------+
```

**Charlotte** — Prompt engine. Block assembly, constitutional synthesis, variable injection, provider rendering.
...
**Premium Handoff Renderer** — Self-contained dark-themed delivery package. Animated governance gauges, OWASP security cards, constitutional principle display, operations kill-switch panel.
